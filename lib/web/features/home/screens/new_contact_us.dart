...
class NewContactUsScreen extends StatefulWidget {
  static const routeName = '/new-contact';
  const NewContactUsScreen({super.key});

  @override
  State<NewContactUsScreen> createState() => _NewContactUsScreenState();
}

bool isContactFormSent = false;

class _NewContactUsScreenState extends State<NewContactUsScreen> {
