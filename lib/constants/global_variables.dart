...
List<Role> listRoleSel = [
  Role('QA Engineering', 'assets/images/rolevectorwhite1.png'),
  Role('Project Management', 'assets/images/rolevectorwhite2.png'),
  Role('Backend', 'assets/images/rolevectorwhite3.png'),
  Role('UI/UX Design', 'assets/images/rolevectorwhite4.png'),
  Role('Full Stack Developer', 'assets/images/rolevectorwhite5.png')
];
